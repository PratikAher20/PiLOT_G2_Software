...
BUILDCMD = arm-none-eabi-gcc -mthumb -mcpu=cortex-m3  -L"E:\PiLOT_G2_Software\PiLOT_G2_Software\PiLOT_G2_IMG2\PiLOT_sb_MSS_CM3_hw_platform\Debug" -TE:\PiLOT_G2_Software\PiLOT_G2_Software\PiLOT_G2_IMG2\PiLOT_sb_MSS_CM3_hw_platform\CMSIS\startup_gcc\production-smartfusion2-execute-in-place.ld -Wl,-Map=$(EXECUTABLE).map -Xlinker -gc-sections 
SHELL := cmd.exe
